...
export default function Services() {
  return (
    <div className="w-full">
      <div
        className="h-[630px] pl-[82px] pr-[738px] pt-[229px] pb-[140px] bg-black/opacity-60 relative bg-cover bg-center flex w-full justify-center items-center"
      ...
      >
        <div className="self-stretch flex-col justify-start items-start gap-8 inline-flex">
          <div className="flex-col justify-start items-start gap-4 flex">
            <div className="text-white text-[64px] font-bold font-['DM Sans'] leading-[76.80px]">
              Trainings{" "}
            </div>
            <div className="w-[620px]">
              <span className="text-white text-lg font-normal font-['DM Sans'] leading-snug">
                At
              </span>
              <span className="text-yellow-600 text-lg font-bold font-['DM Sans'] leading-snug">
                ADLM
              </span>
              <span className="text-white text-lg font-normal font-['DM Sans'] leading-snug">
          ...
          <div className="w-[147px] px-4 py-[14.50px] bg-neutral-100 rounded-lg border border-gray-200 justify-center items-center gap-2.5 inline-flex">
            <div className="text-neutral-800 text-base font-normal font-['DM Sans'] leading-tight">
              Start Learning
            </div>
      ...
      <div className="w-full h-[1213px] pl-[82px] pr-[95px] pt-20 pb-[124.79px] bg-black flex-col justify-start items-start gap-[147px] inline-flex">
        <div className="self-stretch flex-col justify-start items-start gap-4 inline-flex">
          <div className="w-[786px] text-white text-5xl font-bold font-['DM Sans'] leading-[57.60px]">
      ...
      <div className="w-full h-[1059px] pl-[87px] pr-[86px] pt-[81px] pb-[59px] bg-white flex-col justify-end items-center gap-[101px] inline-flex">
        <div className="self-stretch flex-col justify-start items-center gap-4 inline-flex">
          ...
          <div className="text-zinc-500 text-xl font-normal font-['DM Sans'] leading-normal">
        ...
        <div className="self-stretch justify-start items-end gap-5 inline-flex">
          <div className="w-[409px] h-[491px] relative rounded-lg shadow border border-gray-200">
