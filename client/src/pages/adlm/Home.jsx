      ...
      <main className="h-full">
        ...
        <div className=" my-10 lg:my-[160px] p-5  bg-[#F5F5F5] w-full">
          <div className="flex flex-col gap-3">
            ...
            <p className="text-[#828282] font-normal text-[16px]">
              Here are some of the serviecs you tend to benefit when you use
              tthe ADLM Plugin
            </p>
          </div>
              ...
              <div className="flex flex-col">
                ...
                <div className="md:mt-[200px] mt-[50px] flex flex-col gap-4">
                  ...
                  <p className="text-[#828282]">
                    ...
                    how to use BIM tools to carry out 4D, 5D, 6D designs
                    projects
                  </p>
                </div>
              </div>
        ...
        <div className="bg-[#212121] text-white py-16 px-4">
          <div className="text-center mb-12">
            ...
            <p className="mb-8">
              Learn how teams of all sizes are using ADLM to integrate with
              other products to create value.
            </p>
          </div>
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col items-center text-center">
              <blockquote className="mb-4">
                <p className="mb-4">
                  "Innovative digital learning that focuses on training people
                  on how to use BIM tools to carry out 4D, 5D, 6D designs
                  projects."
                </p>
              </blockquote>
