    ...
    <main>
      ...
      {listing && !loading && !error && (
        <div>
          ...
          <div className="fixed top-[13%] right-[3%] z-10 border rounded-full w-12 h-12 flex justify-center items-center bg-slate-300">
            <FaShare
          ...
          {copied && (
            <p className="fixed top-[23%] right-[5%] z-10 border rounded-md p-2bg-slate-100">
              Link Copied
            </p>
          )}
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
            ...
            <div className="flex gap-4">
              <p className="bg-blue-900 w-full max-w-[200px] text-white text-center p-1 rounded-lg">
                {listing.type === "rent" ? "For Rent" : "For Sale"}
              </p>
              {/* //TODO: Fix Discounted Price */}
              {listing.offer && (
                <p className="bg-green-900 w-full max-w-[200px] text-white text-center p-1 rounded-lg">
                  N {+listing.regularPrice} OFF
                </p>
              )}
            </div>
